...
*/
Vue.component("simple_footer_component_1722632313", {
    template: `
    <footer id="footer-section" class="flex-1 bg-gradient-to-r from-purple-900 to-pink-600 bg-opacity-50 backdrop-filter backdrop-blur-lg rounded-lg shadow-lg">
